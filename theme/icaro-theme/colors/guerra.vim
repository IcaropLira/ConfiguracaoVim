...
let g:colors_name = 'guerra'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#201b2d', 235]
let s:bg1        = ['#29233a', 236]
let s:bg2        = ['#352d4b', 237]
let s:bg3        = ['#46395e', 239]
let s:border     = ['#5d4b79', 60]
let s:fg0        = ['#f1eaff', 255]
let s:fg1        = ['#b9aecb', 146]
let s:comment    = ['#857a99', 102]

let s:red        = ['#e55aa9', 169]
let s:red_bright = ['#ff78bd', 211]
let s:red_dim    = ['#a63b8c', 132]
let s:red_soft   = ['#c96de0', 170]

let s:green      = ['#94d8a3', 115]
let s:amber      = ['#f2cf7a', 222]
let s:blue       = ['#a78bf1', 141]
let s:cyan       = ['#75d4df', 116]
let s:orange     = ['#e89a63', 173]
" ------------------------------------------------------------
