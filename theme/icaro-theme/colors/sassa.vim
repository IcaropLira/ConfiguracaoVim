...
let g:colors_name = 'sassa'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#1e1e2e', 235]
let s:bg1        = ['#26263a', 236]
let s:bg2        = ['#31314a', 237]
let s:bg3        = ['#41415c', 239]
let s:border     = ['#585875', 60]
let s:fg0        = ['#cdd6f4', 189]
let s:fg1        = ['#a6adc8', 146]
let s:comment    = ['#7f849c', 103]

let s:red        = ['#cba6f7', 183]
let s:red_bright = ['#f5c2e7', 218]
let s:red_dim    = ['#8839ef', 99]
let s:red_soft   = ['#f38ba8', 211]

let s:green      = ['#a6e3a1', 151]
let s:amber      = ['#f9e2af', 223]
let s:blue       = ['#89b4fa', 111]
let s:cyan       = ['#89dceb', 116]
let s:orange     = ['#fab387', 216]
" Helper
" ------------------------------------------------------------
