...
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#25212d', 235]
let s:bg1        = ['#302a3b', 236]
let s:bg2        = ['#3b334a', 237]
let s:bg3        = ['#4b3e5e', 239]
let s:border     = ['#625375', 60]
let s:fg0        = ['#eee9f8', 255]
let s:fg1        = ['#b9aecb', 146]
let s:comment    = ['#8d809f', 103]

let s:red        = ['#caa6f7', 183]
let s:red_bright = ['#f5c2e7', 218]
let s:red_dim    = ['#8b5cf6', 99]
