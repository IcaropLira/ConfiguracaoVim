" ============================================================
" macvim_light.vim — colorscheme "macvim_light" (Configuracao Vim Icaro Lira)
" Paleta baseada em aunsira/macvim-light
" ============================================================
...
let g:colors_name = 'macvim_light'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#ffffff', 231]
let s:bg1        = ['#F1F5FA', 255]
let s:bg2        = ['#CAE1E1', 253]
let s:bg3        = ['#72F7FF', 87]
let s:border     = ['#c8d3d8', 252]
let s:fg0        = ['#333333', 236]
let s:fg1        = ['#4A708B', 60]
let s:comment    = ['#0000FF', 21]

let s:red        = ['#a71d5d', 125]
let s:red_bright = ['#c9317d', 168]
let s:red_dim    = ['#6e1340', 53]
let s:red_soft   = ['#c14a7a', 132]

let s:green      = ['#009E00', 34]
let s:amber      = ['#FF8C00', 208]
let s:blue       = ['#4A708B', 60]
let s:cyan       = ['#72F7FF', 87]
let s:orange     = ['#e67300', 166]
" ------------------------------------------------------------
