...
let g:colors_name = 'cabeludo'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#062b2f', 234]
let s:bg1        = ['#07383c', 235]
let s:bg2        = ['#0b464b', 23]
let s:bg3        = ['#10585e', 23]
let s:border     = ['#1b747a', 6]
let s:fg0        = ['#e4ffff', 195]
let s:fg1        = ['#86c5c8', 116]
let s:comment    = ['#5d969a', 66]

let s:red        = ['#18d8c8', 44]
let s:red_bright = ['#35f0de', 86]
let s:red_dim    = ['#0e8d87', 30]
let s:red_soft   = ['#2bb7c3', 37]

let s:green      = ['#8de6a1', 115]
let s:amber      = ['#e8d58b', 186]
let s:blue       = ['#74b9ff', 111]
let s:cyan       = ['#65e7f2', 81]
let s:orange     = ['#f2a65a', 215]
" ------------------------------------------------------------
