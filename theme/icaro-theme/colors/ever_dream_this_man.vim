" ============================================================
" ever_dream_this_man.vim — colorscheme "Ever Dream This Man?" (Configuracao Vim Icaro Lira)
" ============================================================
...
let g:colors_name = 'ever_dream_this_man'
...
let s:bg2      = ['#3c3836', 237]
let s:bg3      = ['#504945', 239]
let s:border   = ['#665c54', 59]
let s:fg0      = ['#ebdbb2', 223]
let s:fg1      = ['#a89984', 138]
let s:comment  = ['#928374', 244]

let s:red        = ['#fb4934', 203]
let s:red_bright = ['#fe8019', 208]
let s:red_dim    = ['#9d0006', 124]
let s:red_soft   = ['#d3869b', 175]

let s:green  = ['#b8bb26', 142]
let s:amber  = ['#fabd2f', 214]
let s:blue   = ['#83a598', 108]
