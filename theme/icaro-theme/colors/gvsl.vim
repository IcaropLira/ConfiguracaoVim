...
let g:colors_name = 'gvsl'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#fff6d8', 230]
let s:bg1        = ['#f1e6c4', 224]
let s:bg2        = ['#e7d8ac', 187]
let s:bg3        = ['#d9c693', 186]
let s:border     = ['#c3ab70', 143]
let s:fg0        = ['#29251b', 235]
let s:fg1        = ['#6d644d', 59]
let s:comment    = ['#958a6e', 101]

let s:red        = ['#8a5a24', 94]
let s:red_bright = ['#b77b32', 137]
let s:red_dim    = ['#67401a', 58]
let s:red_soft   = ['#a56b2c', 130]

let s:green      = ['#4d8650', 65]
let s:amber      = ['#8b6b1f', 94]
let s:blue       = ['#4c6d9d', 61]
let s:cyan       = ['#3d7f7a', 66]
let s:orange     = ['#b05d27', 130]
" ------------------------------------------------------------
