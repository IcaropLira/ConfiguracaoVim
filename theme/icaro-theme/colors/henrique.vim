...
let g:colors_name = 'henrique'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#050505', 232]
let s:bg1        = ['#0b0b0b', 232]
let s:bg2        = ['#151515', 233]
let s:bg3        = ['#202020', 234]
let s:border     = ['#333333', 236]
let s:fg0        = ['#eeeeee', 255]
let s:fg1        = ['#999999', 246]
let s:comment    = ['#777777', 243]

let s:red        = ['#ffffff', 15]
let s:red_bright = ['#ffffff', 15]
let s:red_dim    = ['#777777', 243]
let s:red_soft   = ['#bbbbbb', 250]

let s:green      = ['#8bd17c', 114]
let s:amber      = ['#e5c07b', 180]
