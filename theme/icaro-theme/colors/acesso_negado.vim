" ============================================================
" acesso_negado.vim — colorscheme "ACESSO NEGADO" (Configuracao Vim Icaro Lira)
" ============================================================
...
let g:colors_name = 'acesso_negado'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0      = ['#000000', 16]
let s:bg1      = ['#0a0a0a', 232]
let s:bg2      = ['#141414', 233]
let s:bg3      = ['#1e1e1e', 234]
let s:border   = ['#333333', 236]
let s:fg0      = ['#ffffff', 231]
let s:fg1      = ['#aaaaaa', 248]
let s:comment  = ['#777777', 243]

let s:red        = ['#ffffff', 231]
let s:red_bright = ['#ffffff', 231]
let s:red_dim    = ['#888888', 102]
let s:red_soft   = ['#cccccc', 252]

let s:green  = ['#ffffff', 231]
let s:amber  = ['#cccccc', 252]
let s:blue   = ['#dddddd', 253]
let s:cyan   = ['#eeeeee', 255]
let s:orange = ['#bbbbbb', 250]
