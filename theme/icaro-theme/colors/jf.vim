...
let g:colors_name = 'jf'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#f5f2e7', 255]
let s:bg1        = ['#e9e5d7', 254]
let s:bg2        = ['#ddd8c8', 188]
let s:bg3        = ['#d0c8b5', 187]
let s:border     = ['#b7ad98', 144]
let s:fg0        = ['#29261e', 235]
let s:fg1        = ['#6f6a5b', 241]
let s:comment    = ['#928b78', 102]

let s:red        = ['#756b47', 95]
let s:red_bright = ['#a0956a', 137]
let s:red_dim    = ['#4f492f', 238]
let s:red_soft   = ['#8b815b', 101]

let s:green      = ['#4f8155', 65]
let s:amber      = ['#8b6b2a', 94]
let s:blue       = ['#536b94', 60]
let s:cyan       = ['#4f8580', 66]
let s:orange     = ['#aa6930', 131]
" ------------------------------------------------------------
