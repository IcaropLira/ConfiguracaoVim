" ============================================================
" lucid.vim — colorscheme "lucid" (Configuracao Vim Icaro Lira)
" Paleta baseada em cseelus/vim-colors-lucid
" ============================================================
...
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#0f0c14', 233]
let s:bg1        = ['#181320', 234]
let s:bg2        = ['#36323d', 237]
let s:bg3        = ['#fde9a2', 223]
let s:border     = ['#4a4555', 239]
let s:fg0        = ['#e4e0ed', 254]
let s:fg1        = ['#beb8cc', 250]
let s:comment    = ['#847d91', 102]

let s:red        = ['#db0088', 162]
let s:red_bright = ['#ff33aa', 205]
let s:red_dim    = ['#8f0058', 89]
let s:red_soft   = ['#7470ce', 98]

let s:green      = ['#d0ffc3', 193]
let s:amber      = ['#3fc997', 78]
let s:blue       = ['#83a8d1', 110]
let s:cyan       = ['#99feff', 123]
let s:orange     = ['#b3e4eb', 152]
" ------------------------------------------------------------
