" ============================================================
" dijkstra.vim — colorscheme "Dijkstra" (Configuracao Vim Icaro Lira)
" ============================================================
...
let g:colors_name = 'dijkstra'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0      = ['#10161c', 233]
let s:bg1      = ['#182028', 234]
let s:bg2      = ['#212b35', 236]
let s:bg3      = ['#2c3a46', 237]
let s:border   = ['#3a4a58', 239]
let s:fg0      = ['#eaf2f7', 255]
let s:fg1      = ['#8fa5b5', 109]
let s:comment  = ['#6a808f', 66]

let s:red        = ['#5b7f9e', 67]
let s:red_bright = ['#7ba0c0', 109]
let s:red_dim    = ['#3d5a72', 240]
let s:red_soft   = ['#4a8fa8', 67]

let s:green  = ['#7fae8f', 108]
let s:amber  = ['#c9a86a', 179]
let s:blue   = ['#5b7f9e', 67]
let s:cyan   = ['#7fc0c9', 110]
let s:orange = ['#b58a5e', 137]
