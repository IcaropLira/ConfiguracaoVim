" ============================================================
" mateus_sao_paulino.vim — colorscheme "Mateus Sao Paulino" (Configuracao Vim Icaro Lira)
" ============================================================
...
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#f7f5f2', 255]
let s:bg1        = ['#ece9e4', 254]
let s:bg2        = ['#dedad4', 253]
let s:bg3        = ['#d1cbc4', 251]
let s:border     = ['#aaa29a', 247]
let s:fg0        = ['#211d1a', 234]
let s:fg1        = ['#625a54', 240]
let s:comment    = ['#8b8179', 8]

let s:red        = ['#a3122c', 124]
let s:red_bright = ['#cc1f3d', 161]
let s:red_dim    = ['#6e0d1e', 52]
let s:red_soft   = ['#1a1a1a', 234]

let s:green      = ['#287a4a', 29]
let s:amber      = ['#8a6500', 94]
let s:blue       = ['#4b5e7a', 60]
let s:cyan       = ['#387a78', 66]
let s:orange     = ['#a04b1f', 130]
" Helper
" ------------------------------------------------------------
