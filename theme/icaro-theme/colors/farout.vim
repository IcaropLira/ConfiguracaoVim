" ============================================================
" farout.vim — colorscheme "farout" (Configuracao Vim Icaro Lira)
" Paleta baseada em fcpg/vim-farout
" ============================================================
...
let g:colors_name = 'farout'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#0F0908', 232]
let s:bg1        = ['#291916', 234]
let s:bg2        = ['#1F1311', 233]
let s:bg3        = ['#6B4035', 239]
let s:border     = ['#4a3530', 237]
let s:fg0        = ['#E0CCAE', 187]
let s:fg1        = ['#A67458', 137]
let s:comment    = ['#6B4035', 239]

let s:red        = ['#F2A766', 215]
let s:red_bright = ['#F2DDBC', 223]
let s:red_dim    = ['#BF472C', 130]
let s:red_soft   = ['#D47D49', 173]

let s:green      = ['#A67458', 137]
let s:amber      = ['#F2DDBC', 223]
let s:blue       = ['#6B4035', 239]
let s:cyan       = ['#F2A766', 215]
let s:orange     = ['#BF472C', 130]
" ------------------------------------------------------------
