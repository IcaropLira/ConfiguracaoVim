" ============================================================
" jales.vim — colorscheme "Jales" (Configuracao Vim Icaro Lira)
" ============================================================
...
let g:colors_name = 'jales'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#120404', 232]
let s:bg1        = ['#1b0708', 233]
let s:bg2        = ['#270b0d', 233]
let s:bg3        = ['#391114', 234]
let s:border     = ['#55191e', 52]
let s:fg0        = ['#fff1f2', 255]
let s:fg1        = ['#caa0a4', 181]
let s:comment    = ['#8e666b', 95]

let s:red        = ['#d81e2c', 160]
let s:red_bright = ['#ff3344', 203]
let s:red_dim    = ['#7a0d14', 1]
let s:red_soft   = ['#a81020', 124]

let s:green      = ['#76c893', 114]
let s:amber      = ['#f2c14e', 215]
let s:blue       = ['#7ba7d9', 110]
let s:cyan       = ['#7ad8d0', 116]
let s:orange     = ['#f07b4f', 209]
" Helper
" ------------------------------------------------------------
