...
let g:colors_name = 'biscoitinho'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#fff8ed', 15]
let s:bg1        = ['#f4eadb', 254]
let s:bg2        = ['#eadbc8', 253]
let s:bg3        = ['#ddc9b0', 187]
let s:border     = ['#c7ad91', 180]
let s:fg0        = ['#2a2220', 235]
let s:fg1        = ['#6f625b', 241]
let s:comment    = ['#96877b', 102]

let s:red        = ['#c85c91', 168]
let s:red_bright = ['#e27bad', 175]
let s:red_dim    = ['#8f3e66', 95]
let s:red_soft   = ['#b34f82', 132]

let s:green      = ['#4e8c61', 65]
let s:amber      = ['#9a6b20', 94]
let s:blue       = ['#4d6e9f', 61]
let s:cyan       = ['#3e8785', 66]
let s:orange     = ['#b66b2f', 130]
" ------------------------------------------------------------
