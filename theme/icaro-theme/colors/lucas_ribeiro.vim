" ============================================================
" lucas_ribeiro.vim — colorscheme "Lucas ->Ribeiro?" (Configuracao Vim Icaro Lira)
" ============================================================
...
let g:colors_name = 'lucas_ribeiro'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#14110a', 233]
let s:bg1        = ['#211b0d', 234]
let s:bg2        = ['#302712', 235]
let s:bg3        = ['#413617', 236]
let s:border     = ['#5a4b22', 58]
let s:fg0        = ['#f8efd7', 230]
let s:fg1        = ['#c7b994', 180]
let s:comment    = ['#91815c', 101]

let s:red        = ['#d4af37', 179]
let s:red_bright = ['#ffd700', 220]
let s:red_dim    = ['#8a6c1e', 94]
let s:red_soft   = ['#c9a227', 178]

let s:green      = ['#86b86b', 107]
let s:amber      = ['#f0d98a', 222]
let s:blue       = ['#7aa0c4', 110]
let s:cyan       = ['#75c9ba', 115]
let s:orange     = ['#d88a3d', 173]
" Helper
" ------------------------------------------------------------
