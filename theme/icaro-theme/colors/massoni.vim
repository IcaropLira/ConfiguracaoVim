...
let g:colors_name = 'massoni'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#16171d', 234]
let s:bg1        = ['#1e2028', 235]
let s:bg2        = ['#282b37', 236]
let s:bg3        = ['#343844', 237]
let s:border     = ['#4a5162', 240]
let s:fg0        = ['#e8ebf2', 255]
let s:fg1        = ['#9da5b5', 248]
let s:comment    = ['#737b8d', 8]

let s:red        = ['#7488e8', 104]
let s:red_bright = ['#91a5ff', 111]
let s:red_dim    = ['#4658a8', 61]
let s:red_soft   = ['#6f7fe0', 68]

let s:green      = ['#7bc98d', 114]
let s:amber      = ['#d8c875', 186]
let s:blue       = ['#77a6ed', 111]
let s:cyan       = ['#67c9d0', 80]
let s:orange     = ['#db945e', 173]
" ------------------------------------------------------------
