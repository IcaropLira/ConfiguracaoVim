...
let g:colors_name = 'toyman'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#08070b', 232]
let s:bg1        = ['#100c14', 233]
let s:bg2        = ['#18111e', 234]
let s:bg3        = ['#25172d', 235]
let s:border     = ['#8d2b83', 90]
let s:fg0        = ['#f7eefa', 255]
let s:fg1        = ['#bca8bd', 249]
let s:comment    = ['#826c86', 96]

let s:red        = ['#ff2f9b', 198]
let s:red_bright = ['#ff5bb3', 205]
let s:red_dim    = ['#a61b72', 125]
let s:red_soft   = ['#d02b8c', 162]

let s:green      = ['#8ad88e', 114]
let s:amber      = ['#efcb72', 221]
let s:blue       = ['#8ca9ff', 111]
let s:cyan       = ['#72d6d8', 80]
let s:orange     = ['#e9955c', 173]
" ------------------------------------------------------------
