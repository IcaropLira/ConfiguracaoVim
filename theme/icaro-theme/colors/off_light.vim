" ============================================================
" off_light.vim — colorscheme "Of(f) light" (Configuracao Vim Icaro Lira)
" ============================================================
...
let g:colors_name = 'off_light'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#ffffff', 15]
let s:bg1        = ['#f2f2f2', 255]
let s:bg2        = ['#e6e6e6', 254]
let s:bg3        = ['#d6d6d6', 188]
let s:border     = ['#b3b3b3', 249]
let s:fg0        = ['#161616', 233]
let s:fg1        = ['#555555', 240]
let s:comment    = ['#777777', 243]

let s:red        = ['#333333', 236]
let s:red_bright = ['#000000', 0]
let s:red_dim    = ['#666666', 241]
let s:red_soft   = ['#444444', 238]

let s:green      = ['#444444', 238]
let s:amber      = ['#666666', 241]
let s:blue       = ['#3a3a3a', 237]
let s:cyan       = ['#555555', 240]
let s:orange     = ['#222222', 235]
" Helper
" ------------------------------------------------------------
