" ============================================================
" burgundy.vim — colorscheme "burgundy" (Configuracao Vim Icaro Lira)
" Paleta baseada em elliothatch/burgundy.vim
" ============================================================
...
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#1a0a16', 233]
let s:bg1        = ['#240d19', 234]
let s:bg2        = ['#30111d', 234]
let s:bg3        = ['#611835', 53]
let s:border     = ['#4a1f30', 236]
let s:fg0        = ['#f2ead7', 254]
let s:fg1        = ['#f2c9db', 224]
let s:comment    = ['#9e0c46', 125]

let s:red        = ['#d11b2d', 160]
let s:red_bright = ['#f76c9a', 204]
let s:red_dim    = ['#611835', 53]
let s:red_soft   = ['#c9265a', 161]

let s:green      = ['#f0bf69', 215]
let s:amber      = ['#c763a4', 169]
let s:blue       = ['#991667', 89]
let s:cyan       = ['#f2c9db', 224]
let s:orange     = ['#d11b2d', 160]
" ------------------------------------------------------------
