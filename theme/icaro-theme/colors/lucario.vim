" ============================================================
" lucario.vim — colorscheme "lucario" (Configuracao Vim Icaro Lira)
" Paleta baseada em dmcgrady/vim-lucario
" ============================================================
...
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#2b3e50', 237]
let s:bg1        = ['#19242f', 235]
let s:bg2        = ['#405160', 239]
let s:bg3        = ['#66747f', 243]
let s:border     = ['#56636e', 241]
let s:fg0        = ['#f8f8f2', 255]
let s:fg1        = ['#c6d5e0', 188]
let s:comment    = ['#5c98cd', 68]

let s:red        = ['#ff6541', 203]
let s:red_bright = ['#ff8f70', 209]
let s:red_dim    = ['#b33d24', 130]
let s:red_soft   = ['#ffa58c', 216]

let s:green      = ['#72c05d', 71]
let s:amber      = ['#e6db74', 186]
let s:blue       = ['#81a6c7', 110]
let s:cyan       = ['#66d9ef', 81]
let s:orange     = ['#e6a23c', 179]
" ------------------------------------------------------------
