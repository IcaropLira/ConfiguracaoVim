...
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#111323', 234]
let s:bg1        = ['#171a30', 234]
let s:bg2        = ['#202545', 236]
let s:bg3        = ['#2b3158', 237]
let s:border     = ['#3d4775', 239]
let s:fg0        = ['#ececff', 255]
let s:fg1        = ['#9da7cf', 146]
let s:comment    = ['#707aa0', 67]

let s:red        = ['#c23b9b', 132]
let s:red_bright = ['#e85ab9', 169]
let s:red_dim    = ['#842a78', 5]
let s:red_soft   = ['#b34fae', 133]

let s:green      = ['#8fd6a3', 115]
let s:amber      = ['#e7cf7a', 186]
let s:blue       = ['#8aa7f7', 111]
let s:cyan       = ['#73d5d1', 80]
let s:orange     = ['#e39a62', 173]
" ------------------------------------------------------------
