...
let g:colors_name = 'ruiva'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#080609', 232]
let s:bg1        = ['#110b10', 233]
let s:bg2        = ['#1c0f19', 233]
let s:bg3        = ['#291326', 234]
let s:border     = ['#47203c', 237]
let s:fg0        = ['#f8e9f3', 255]
let s:fg1        = ['#b89aaa', 248]
let s:comment    = ['#806273', 95]

let s:red        = ['#e83e8c', 168]
let s:red_bright = ['#ff65ad', 205]
let s:red_dim    = ['#9d174d', 125]
let s:red_soft   = ['#c0266f', 125]

let s:green      = ['#86d993', 114]
let s:amber      = ['#f0ca7a', 222]
let s:blue       = ['#7ea7e8', 110]
let s:cyan       = ['#6fd0d0', 80]
let s:orange     = ['#e48a5b', 173]
" ------------------------------------------------------------
