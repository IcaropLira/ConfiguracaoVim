" ============================================================
" maria_isabel.vim — colorscheme "Maria Isabel" (Configuracao Vim Icaro Lira)
" ============================================================
...
let g:colors_name = 'maria_isabel'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#121212', 233]
let s:bg1        = ['#191919', 234]
let s:bg2        = ['#222222', 235]
let s:bg3        = ['#2d2d2d', 236]
let s:border     = ['#404040', 238]
let s:fg0        = ['#f0f0f0', 255]
let s:fg1        = ['#9d9d9d', 247]
let s:comment    = ['#707070', 242]

let s:red        = ['#1DB954', 35]
let s:red_bright = ['#1ed760', 41]
let s:red_dim    = ['#168a3f', 29]
let s:red_soft   = ['#1DB954', 35]

let s:green      = ['#69d98b', 78]
let s:amber      = ['#d8c55b', 185]
let s:blue       = ['#76a7e8', 110]
let s:cyan       = ['#64c7c0', 79]
let s:orange     = ['#e59d55', 179]
" Helper
" ------------------------------------------------------------
