...
let g:colors_name = 'baiana'

" ------------------------------------------------------------
" Paleta
" ------------------------------------------------------------
let s:bg0        = ['#222222', 235]
let s:bg1        = ['#292929', 235]
let s:bg2        = ['#333333', 236]
let s:bg3        = ['#3f3f3f', 237]
let s:border     = ['#555555', 240]
let s:fg0        = ['#f2f2f2', 255]
let s:fg1        = ['#aaaaaa', 248]
let s:comment    = ['#777777', 243]

let s:red        = ['#d94f9d', 169]
let s:red_bright = ['#f16db5', 205]
let s:red_dim    = ['#a72e75', 126]
let s:red_soft   = ['#c13b8d', 132]

let s:green      = ['#7dd58b', 114]
let s:amber      = ['#e7c96f', 185]
let s:blue       = ['#79a9e8', 110]
let s:cyan       = ['#63c9c4', 80]
let s:orange     = ['#df925b', 173]
" ------------------------------------------------------------
