" ============================================================
" Tema do vim-airline "alan_turing" — Alan Turing
" ============================================================
...
let s:red = '#e85aa8'
let s:red_bright = '#ff76bd'
let s:red_dim = '#a94691'
let s:red_soft = '#c56adf'
let s:amber = '#f2cf73'
...
let g:airline#themes#alan_turing#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)

let s:V1 = [ s:black, s:red_soft, s:t_black, s:t_red_soft ]
let s:V2 = s:N2
let s:V3 = [ s:red_soft, s:black, s:t_red_soft, s:t_black ]
let g:airline#themes#alan_turing#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)

let s:R1 = [ s:fg, s:red, s:t_fg, s:t_red ]
let s:R2 = s:N2
let s:R3 = [ s:red, s:black, s:t_red, s:t_black ]
let g:airline#themes#alan_turing#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)

let s:IA1 = [ s:fg_dim, s:black, s:t_fgdim, s:t_black ]
let s:IA2 = [ s:fg_dim, s:panel, s:t_fgdim, s:t_panel ]
let s:IA3 = s:IA2
let g:airline#themes#alan_turing#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
...
let g:airline#themes#alan_turing#palette.tabline.airline_tabtype  = s:T2
