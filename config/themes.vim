...
let g:icaro_themes = [
      ...
      \ {'id': 'alan_turing_antiresenha', 'title': 'Alan Turing',    'short': 'AT',  'subtitle': 'Antiresenha'},
      ...
      \ {'id': 'raul',               'title': 'Raul',                  'short': 'RAU', 'subtitle': 'Pensão de Pet'},
      \ {'id': 'acesso_negado',      'title': 'ACESSO NEGADO',         'short': 'NEG', 'subtitle': ''},
      \ {'id': 'espresso',           'title': 'De cujos',              'short': 'CUJ', 'subtitle': 'Antagonistas'},
      \ {'id': 'plum',               'title': 'Titio',                 'short': 'TIT', 'subtitle': 'Goats'},
      \ {'id': 'flatui',             'title': 'Animes',                'short': 'ANI', 'subtitle': 'Antagonistas'},
      \ {'id': 'neocybervim',        'title': 'Cavaleiro do apocalipse', 'short': 'CAV', 'subtitle': 'Antagonistas'},
      \ {'id': 'sunbather',          'title': 'Guardians',             'short': 'GUA', 'subtitle': 'Antagonistas'},
      \ {'id': 'tatami',             'title': 'Shampoo de...',         'short': 'SHA', 'subtitle': 'Antagonistas'},
      \ {'id': 'lucid',              'title': 'Cuti Cuti',             'short': 'CUT', 'subtitle': 'Goats'},
      \ {'id': 'lucario',            'title': 'Eurico',                'short': 'EUR', 'subtitle': 'Goats'},
      \ {'id': 'roti',               'title': 'Do bem',                'short': 'BEM', 'subtitle': 'Pensão de Pet+'},
      \ {'id': 'hotdog',             'title': 'Héctor',                'short': 'HEC', 'subtitle': 'Pensão de Pet comunista'},
      \ {'id': 'macvim_light',       'title': 'JA',                    'short': 'JA',  'subtitle': 'Goats'},
      \ {'id': 'farout',             'title': 'Holanda',               'short': 'HOL', 'subtitle': 'Goats'},
      \ {'id': 'burgundy',           'title': 'Ela também é maligna...', 'short': 'MAL2', 'subtitle': 'Antagonistas'},
      \ {'id': 'petra',              'title': 'Sonhei com você essa noite', 'short': 'SON', 'subtitle': 'Não tenho descrição para isso'},
      \ ]
